    ...
    <div>
              ...
              <div className="relative lg:max-w-md">
                ...
                <div className="absolute bottom-0 right-0 z-10 p-8 bg-white border-4 border-blue-500 rounded shadow dark:border-blue-400 lg:-mb-8 lg:-mr-11 sm:p-8 dark:text-gray-300 dark:bg-gray-800 ">
                  <p className="text-lg font-semibold md:w-72">
                    ...
                    Successfully Organizing events  from 5 years
                  </p>
                </div>
              </div>
            </div>
     ...
     data-aos-easing="ease-in-sine" className="w-full px-6 mb-10 lg:w-1/2 lg:mb-0 ">
              ...
              <p className="mb-6 text-base leading-7 text-gray-500 dark:text-gray-400">
                Welcome to [Your Event Planner Website Name], where we transform
                your dreams into unforgettable moments! With a passion for
                celebration and an eye for detail, we are your go-to partner for
                all your special occasions. Whether it is a wedding, birthday
                party, anniversary, baby shower, or any other event that you
                hold dear, we are here to make it extraordinary. Our journey
                began with a simple belief: every milestone in life deserves to
                be celebrated in style. With years of experience in the event
                planning industry, our dedicated team has honed the art of
                curating memorable moments that reflect your unique personality
                and preferences.
              </p>
              <a
                href="#"
